            ...
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-3xl font-bold mb-2">
                  Insights from the <span className="text-primary">Edge</span>
                </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group cursor-pointer">
                <div className="relative aspect-video rounded-xl overflow-hidden mb-4 border border-white/5">
                  <Image
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBUjIZwuLqWl6dh4eOlGFo0ycE-j-7Skh1aS9OeZFXr-W0GtoUD5Bi9RdAfpUeqGwyTFhhKNOHk1mTyTUeVvQYPyUT4cFClDQJAzzjppbduoa6b7Sk1OB5lGuNM7-Td33UMuriw6PR83vvmXhl-BsZFohNPTGXTDu_a0Sazv0PiGzVo85ljuxki-fF8Fl9-jJhcsq09WgOAeArUw8M3i9tuSg4ctWNYBJNn_h--ln5NoixTpJ3GBRovIpfGbLI76H9tFjopuiWdhEM"
                    alt="Abstract glowing blue neural network visualization"
                    fill
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">
                  The LLM Revolution: Beyond Simple Prompts
                </h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  How we are integrating autonomous agents into enterprise-grade
                  web applications...
                </p>
              ...
              <div className="group cursor-pointer">
                <div className="relative aspect-video rounded-xl overflow-hidden mb-4 border border-white/5">
                  <Image
                    ...
                    alt="Clean futuristic data dashboard with graphs"
                    fill
                    className="object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                  <div className="absolute top-4 left-4 bg-background-dark/80 backdrop-blur px-3 py-1 rounded text-[10px] font-bold text-primary uppercase border border-primary/30">
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">
                  Scaling to 1M Users with Edge Functions
                </h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  A post-mortem on our latest architectural shift and the 40%
                  performance gain we achieved...
                </p>
                <span className="text-xs text-slate-500">
              ...
              <div className="group cursor-pointer">
                <div className="relative aspect-video rounded-xl overflow-hidden mb-4 border border-white/5">
                  <Image
                    ...
                    alt="Futuristic blue isometric tech structure"
                    fill
                    className="object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                  <div className="absolute top-4 left-4 bg-background-dark/80 backdrop-blur px-3 py-1 rounded text-[10px] font-bold text-primary uppercase border border-primary/30">
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">
                  Modern Web: The End of Multi-Page Apps?
                </h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  Exploring the convergence of server-side rendering and
                  client-side interactivity in 2024...
                </p>
                <span className="text-xs text-slate-500">
                  6 min read • Jul 28, 2023
                </span>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 px-6 relative overflow-hidden">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-nowrap overflow-x-auto gap-8 pb-12 scrollbar-hide snap-x">
              {/* Testimonial 1 */}
              <div className="min-w-87.5 md:min-w-112.5 snap-center bg-background-dark border border-slate-800 p-8 rounded-xl relative group">
                ...
                <p className="text-slate-300 italic mb-8 leading-relaxed">
                  "The curriculum at KasauliCoder is intense but rewarding. I
                  went from a junior dev to leading an AI-focused team in just 4
                  months. The mentorship is world-class."
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full border border-primary/30 p-0.5 relative">
                    <Image
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBYX_GJGdVa2g53ZXo_gYvIyWUEOMbtekO9Pwf3eqiSIGYQkNjEgV4GH8Yzka5egS4_YO9FS9HQ6w7GywJfEEqpRvCWvH5qyxjURHB3Q8oGBCqXz1hw--o8OdAUG_smLp7LOOroojOfiS0ZMBJFj6x5hfokFhC2CIClPeSuawOZcZaPdEijAyS2p6xtjtpClWgdgCsKF-HVEFnXgIPLmjxAA6TinWNrEmIIXhehdtkr5e7XfjXInRpkQZSUwAm-Cd91blgvqRi7alk"
                      alt="Portrait of a male developer smiling"
                      fill
                      className="object-cover rounded-full"
                    />
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-100">Alex Rivera</h4>
              ...
              {/* Testimonial 2 */}
              <div className="min-w-87.5 md:min-w-112.5 snap-center bg-background-dark border border-slate-800 p-8 rounded-xl relative">
                <div className="absolute -top-4 -right-4 w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center border border-primary/40">
                  <span className="material-symbols-outlined text-primary">
                    format_quote
                  </span>
                ...
                <p className="text-slate-300 italic mb-8 leading-relaxed">
                  "The focus on architectural patterns rather than just syntax
                  changed the way I think about code. It's not just a course;
                  it's an engineering mindset upgrade."
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full border border-primary/30 p-0.5 relative">
                    <Image
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuC8uhV46FrtfwSfk6jmFCi31HGf8a6gEI_3XJnWQr7loXgo96DZq0Td5zA66tRu_OhcQdADAC8B4cBJhmTpLzUTYeq6DMCdRRAuFE5c-cxl4Fvjdr1lrBjl3OHbG-yhGtpJSVyq6J7fyaq-exlgYHUbK5Z7YLSuRUuLz4dtUTm7j8EFDzAjCWzUTLiwV8muyLfL-uRNPc1DJxAsZ5DsKvVHwFZZyU5CPgCMvRNnJnun43rUK2Gx9B3uSjHjks4KzY55Ia8SaeqOw-8"
                      alt="Portrait of a female developer smiling"
                      fill
                      className="object-cover rounded-full"
                    />
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-100">Sarah Chen</h4>
                    <p className="text-xs text-slate-500">
                      Senior Architect @ CloudScale
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="min-w-87.5 md:min-w-112.5 snap-center bg-background-dark border border-slate-800 p-8 rounded-xl relative">
                ...
                <p className="text-slate-300 italic mb-8 leading-relaxed">
                  "Finally, a program that bridges the gap between 'Hello World'
                  and professional enterprise systems. Worth every penny of the
                  investment."
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full border border-primary/30 p-0.5 relative">
                    <Image
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBoUehh7Ba7_0RCwqxlTyWJUxC33htuRfgzpqbvJWncHUh_i2Ei4Cgei3ixbh_KjGAgnbL486YoC4lfqCWUzcVkzWGGJwBzBaHtPYbgLAIKE5cblHNAujZK8fLRRQFnPvRJmjSPEMkuoUPSIlLchsAjpX97bTVNP4_uZI-sDkTnbQWpY6c2XT9icI5QE8Hbq2_g-FUcJ8I2nHf9D9fj71tnD8RALfm4M7Nhv6Ui0c2oS15x624yXfgYMk3xdLVRHH9kmcK5BPqSPWc"
                      alt="Portrait of a young male developer"
                      fill
                      className="object-cover rounded-full"
                    />
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-100">Marcus Thorne</h4>
                    <p className="text-xs text-slate-500">
                      Fullstack Dev @ NeonLabs
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex gap-4">
                <button className="bg-primary text-background-dark px-8 py-3 rounded font-bold hover:scale-105 transition-transform">
                  REGISTER NOW
                </button>
                <button className="border border-slate-700 px-8 py-3 rounded font-bold hover:bg-white/5 transition-colors">
                  BOOK A CONSULTATION
                </button>
              </div>
